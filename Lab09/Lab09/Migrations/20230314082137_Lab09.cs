...
{
    /// <inheritdoc />
    public partial class Lab09 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Customer__A4AE64B8C347344F", x => x.CustomerID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Orders__C3905BAF5A39574B", x => x.OrderID);
                    table.ForeignKey(
